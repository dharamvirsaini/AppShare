...
//        premium_text.setText(Html.fromHtml(htmlString));
        ...
        ((TextView)findViewById(R.id.privacy_text)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.participateme.com/privacy_policy/"));
